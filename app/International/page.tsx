  ...
  const hreoDeta = [
    {
      ...
      description: "INTERNATIONAL EXCLUSIVELY FOR YOU",
    }
  ];
  const featuresData = [
    {
      name: "Feature 1",
      description: "We believe the process will bear a meaning only when the goods are delivered to the right person, at the right time, at the right place and in the right manner. ",
    },
    {
      name: "Feature 2",
      description: "Bookings should be made at least Four hours prior to flight departure time. The maximum acceptable dimensions for each package are L48”XB52”XH34”, with individual package weight not exceeding 100kgs.",
    },
...
<span key={index}>{item.description}</span>
    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
          ...
          Airport cargo Services process to deliver shipment All Airports in India with booking all type of shipment priority based as per next flight schedule and space reserve to carry shipment for all flights passengers and Cargo Airlines . 
          </p>
